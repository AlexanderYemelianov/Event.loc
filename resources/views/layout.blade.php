...
<div class="navbar-fixed-bottom row-fluid" style="background: #ffffff; height: 60px;">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 hidden-xs">
                        <address style="font-size: 15px;">
                            <abbr title="Phone">моб.тел:</abbr><a href="tel:{{$phone}}">{{$phone}}</a> - {{$contactName}}<br>
                    ...
                    <div class="hidden-lg hidden-md hidden-sm col-xs-6">
                        <address style="font-size: 10px; padding-top: 5px;">
                            <abbr title="Phone">моб.тел:</abbr><a href="tel:{{$phone}}">{{$phone}}</a> - {{$contactName}}<br>
                            <a href="{{$contactEmail}}">{{$contactEmail}}</a>
                        </address>
                    </div>

                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" align="right" style="padding-top: 10px;">
                        <a href="{{$fbLink}}" target="_blank"><img src="../iconz/facebook.png" alt="Facebook" height="40px"></a>
                        <a href="{{$igLink}}" target="_blank"><img src="../iconz/instagram.png" alt="Instagram" height="40px"></a>
                    </div>
                </div>
            </div>
        </footer>
